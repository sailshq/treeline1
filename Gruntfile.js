...
module.exports = function (grunt) {
  ...
  var depsPath = grunt.option('gdsrc') || 'node_modules';
  ...
  grunt.registerTask('syncMachines', 'Sync new custom machines up to server', function() {

    var done = this.async();
    var baseurl = grunt.option('baseurl');
    var url = baseurl + "/__loadmachines";
    require('http').get(url, function(r) {grunt.log.writeln('Uploaded machines to Treeline'); done();})
    .on('error', function(err) {grunt.log.writeln(err); done();});
