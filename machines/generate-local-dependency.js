module.exports = {
  ...
  friendlyName: 'Generate local dependency',


  description: 'Generate a folder and files from the provided dependency machinepack data.',
  ...
  inputs: {
    ...
    destination: {
      description: 'Absolute path to the machinepack that this is a dependency of.',
  ...
  fn: function (inputs,exits) {
    ...
    var pkgMetadata;
    if (packData.npmPackageName) {
      pkgMetadata = {
        dependencies: {}
      };
      pkgMetadata.dependencies[packData.npmPackageName] = packData.version;
    } else {
      pkgMetadata = {
        private: true,
        name: packData._id,
    ...
    Filesystem.writeJson({
      ...
      success: function (){
        ...
        var indexJsPath = path.resolve(dependencyDir,'index.js');
        var indexJsCode;
        if (packData.npmPackageName) {
          indexJsCode = "module.exports = require('" + packData.npmPackageName + "');";
        } else {
          indexJsCode = '// This is a boilerplate file which should not need to be changed.\nmodule.exports = require(\'machine\').pack({\n  pkg: require(\'./package.json\'),\n  dir: __dirname\n});\n';
        }
        Filesystem.write({
          ...
          success: function (){
            ...
            async.each(packData.machines, function (thisMachine, next){
              ...
              var machineModulePath = path.resolve(dependencyDir, 'machines', thisMachine.identity+'.js');
